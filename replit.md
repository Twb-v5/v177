...
## 📱 Home Screen Layout (Web + Mobile)

### ترتيب الشاشة الرئيسية (محدّث)

**قسم ١ — رحلتك الروحية** (أول)
| البطاقة | النوع | وصف |
|---------|-------|-----|
| البوت الزكي | بطاقة مميزة (GPT-4o) | شرائح ميزات: يتذكر قصتك، صوت لصوت، إرشاد روحي |
| القرآن الكريم | بطاقة غنية | إحصاءات ١١٤/٣٠، آية، ورد اليوم (AsyncStorage) |
| رحلة ٣٠ يوماً | بطاقة كاملة | ← `/journey` |
| برامج إسلامية | بطاقة كاملة | ← `/programs` |
| الأذكار والأدعية | بطاقة كاملة | ← `/adhkar` |

**قسم ٢ — أدواتك اليومية** (ثانياً — شبكة 2×4)
| الصف | اليمين | اليسار |
|------|--------|--------|
| ١ | مسبحة الذكر | مواقيت الصلاة |
| ٢ | الإشعارات | الإعدادات |
| ٣ | الكفارات | مكتبة الرجاء |
| ٤ | يومياتي | دليل الذنوب |

### PremiumHero (Realtime Data)
- **مواقيت الصلاة**: GPS + AlAdhan API — حساب الصلاة القادمة، التقدم، الوقت المتبقي
